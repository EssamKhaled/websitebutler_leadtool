...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'company_list_mapper_service' => 'getCompanyListMapperServiceService',
            'company_list_uploader_service' => 'getCompanyListUploaderServiceService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('yjwRx-jmi0', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2ahud+A8Wj', 0, '8d5DVucA56MI08T5xOGe6m', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, ${($_ = isset($this->services['templating.locator']) ? $this->services['templating.locator'] : $this->getTemplating_LocatorService()) && false ?: '_'}), 1 => $this->get('kernel.class_cache.cache_warmer'), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 3 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\ValidatorCacheWarmer($this->get('validator.builder'), (__DIR__.'/validation.php'), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LJhyujZuYp', 0, '8d5DVucA56MI08T5xOGe6m', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE))), 4 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 5 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\AnnotationsCacheWarmer(${($_ = isset($this->services['annotations.reader']) ? $this->services['annotations.reader'] : $this->getAnnotations_ReaderService()) && false ?: '_'}, (__DIR__.'/annotations.php'), ${($_ = isset($this->services['cache.annotations']) ? $this->services['cache.annotations'] : $this->getCache_AnnotationsService()) && false ?: '_'}), 6 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c, array()), 7 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheWarmer($this->get('twig'), new \Symfony\Bundle\TwigBundle\TemplateIterator($a, ($this->targetDirs[3].'/app'), array())), 8 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'company_list_mapper_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CompanyMapperBundle\Service\CompanyListMapper A CompanyMapperBundle\Service\CompanyListMapper instance
     */
    protected function getCompanyListMapperServiceService()
    {
        return $this->services['company_list_mapper_service'] = new \CompanyMapperBundle\Service\CompanyListMapper($this->get('phpexcel'), ($this->targetDirs[3].'/app/../web/uploads/company_list'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'company_list_uploader_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CompanyMapperBundle\Service\FileUploader A CompanyMapperBundle\Service\FileUploader instance
     */
    protected function getCompanyListUploaderServiceService()
    {
        return $this->services['company_list_uploader_service'] = new \CompanyMapperBundle\Service\FileUploader(($this->targetDirs[3].'/app/../web/uploads/company_list'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'websitebutler', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CompanyMapperBundle/Entity'))), 'CompanyMapperBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CompanyMapperBundle' => 'CompanyMapperBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d315a59e58dcf5c9f68b057a5de66e073a0a093862743b2f9c41c4bf744522d2');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CompanyMapperBundle/Resources/views'), 'CompanyMapper');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('4bbcb1d53b72d7c560875af70696b2b633638efc');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lsTrYlOc13', 0, '8d5DVucA56MI08T5xOGe6m', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f8fa347ba4e1.30541936')), true);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CompanyMapperBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CompanyMapperBundle'),
            ...
            case 'company_list_directory': $value = ($this->targetDirs[3].'/app/../web/uploads/company_list'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CompanyMapperBundle' => 'CompanyMapperBundle\\CompanyMapperBundle',
            ...
            'secret' => '4bbcb1d53b72d7c560875af70696b2b633638efc',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '4bbcb1d53b72d7c560875af70696b2b633638efc',
